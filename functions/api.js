...
const UpdateHubspotContact = async (data, id) => {
  ...
  try {
      ...
      .patch(
        `https://api.hubapi.com/crm/v3/objects/contacts/${id}`,
        {
          properties: {
            ...
            firstname: first_name || 'Name Unknown',
            lastname: last_name || 'Last Name Unknown',
            phone: phone || 'Phone Number Unknown',
          },
        },
        {
          headers: {
    ...
    console.log("Error: Couldn't update contact");
  }
};
...
const AddHubspotContact = async (data) => {
  ...
  try {
    ...
    console("Error: Couldn't Add Contact");
  }
};
...
const HubspotSearch = async (data) => {
  ...
  try {
    ...
    console.log("Error: Couldn't search for contact");
  }
};
